...
export namespace fd::csgo
{
    ...
    class IEngineSound
    {
      public:
        ...
        virtual bool PrecacheSound(const char* pSample, bool Preload = false, bool IsUISound = false) = 0;
        ...
        virtual int EmitSound(IRecipientFilter& filter,
                              ...
                              const math::vector3* pOrigin                = 0,
                              const math::vector3* pDirection             = 0,
                              valve_vector<math::vector3>* pUtlVecOrigins = 0,
        ...
        virtual void StopSoundByGuid(int guid, bool ForceSync)                                                                            = 0;
        virtual void SetVolumeByGuid(int guid, float fvol)                                                                                = 0;
        virtual void unk()                                                                                                                = 0;
        virtual void GetActiveSounds(valve_vector<SndInfo_t>& sndlist)                                                                    = 0;
