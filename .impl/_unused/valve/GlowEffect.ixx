...
export namespace fd::csgo
{
    ...
    struct GlowObject_t
    {
        ...
        base_entity* entity;                  // 0x04
        std::array<float, 4> color;           // 0x08
        bool alpha_capped_by_render_alpha;    // 0x18
        uint8_t pad0[0x3];                    // 0x19 - pack 1 bool as 4 bytes
        ...
        uint8_t pad1[0x1];                    // 0x2B  - pack 3 bool as 4 bytes
    ...
    {
        valve_vector<GlowObject_t> glow_object_definitions;
        int first_free_slot;
        valve_vector<GlowBoxObject_t> glow_box_definitions;
    };
} // namespace fd::csgo
