...
export namespace fd::csgo
{
    ...
    struct WorldListInfo_t
    {
        ...
        int m_LeafCount;
        bool HasWater;
        WorldListLeafData_t* LeafDataList;
    };
    ...
    class IBrushRenderer
    {
      public:
        ...
        virtual bool RenderBrushModelSurface(client_entity* pBaseEntity, IBrushSurface* pBrushSurface) = 0;
    };
    ...
    class IVRenderView
    {
      ...
      public:
        virtual void DrawBrushModel(client_entity* baseentity, model_t* model, const math::vector3& origin, const math::qangle& angles, bool sort) = 0;
        ...
        virtual void BuildWorldLists(IWorldRenderList* pList,
                                     ...
                                     int iForceFViewLeaf,
                                     const VisOverrideData_t* pVisData = 0,
        ...
        virtual void ViewDrawFade(uint8_t* color, material* pMaterial)                                                                                                   = 0;
        ...
        virtual void SetFogVolumeState(int nVisibleFogVolume, bool UseHeightFog)                                                                                         = 0;
        virtual void InstallBrushSurfaceRenderer(IBrushRenderer* pBrushRenderer)                                                                                         = 0;
        virtual void DrawBrushModelShadow(client_renderable* pRenderable)                                                                                                = 0;
        ...
        virtual void Push3DView(const view_setup& view, int nFlags, ITexture* pRenderTarget, Frustum frustumPlanes)                                                      = 0;
        virtual void Push2DView(const view_setup& view, int nFlags, ITexture* pRenderTarget, Frustum frustumPlanes)                                                      = 0;
        ...
        virtual void DrawBrushModelShadowDepth(client_entity* baseentity, model_t* model, const math::vector3& origin, const math::qangle& angles, bool Sort)            = 0;
        virtual void UpdateBrushModelLightmap(model_t* model, client_renderable* pRenderable)                                                                            = 0;
        ...
        virtual void Push3DView(const view_setup& view, int nFlags, ITexture* pRenderTarget, Frustum frustumPlanes, ITexture* pDepthTexture)                             = 0;
        virtual void GetMatricesForView(const view_setup& view,
                                        math::view_matrix* pWorldToView,
                                        math::view_matrix* pViewToProjection,
                                        math::view_matrix* pWorldToProjection,
                                        math::view_matrix* pWorldToPixels)                                                                                               = 0;
    };
} // namespace fd::csgo
