...
export module fd.valve.engine_client;
export import fd.valve.material_system;
...
struct engine_client
{
    ...
    virtual void SolidMoved(class client_entity* pSolidEnt, class collideable* pSolidCollide, const vector3* pPrevAbsOrigin, bool accurateBboxTriggerChecks) = 0;
    virtual void TriggerMoved(class client_entity* pTriggerEnt, bool accurateBboxTriggerChecks)                                                              = 0;
    ...
    virtual void SphereTracePaintSurface(const model_t* model,
