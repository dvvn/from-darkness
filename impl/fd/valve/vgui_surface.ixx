...
export module fd.valve.vgui_surface;
...
//-----------------------------------------------------------------------------
struct vgui_surface : app_system
{
    ...
    virtual void RestrictPaintToSinglePanel(vgui::VPANEL panel, bool ForceAllowNonModalSurface = false)                                                                         = 0;
    ...
    virtual void DrawTexturedPolygon(int n, Vertex_t* pVertice, bool ClipVertices = true)                                                                                       = 0;
};
