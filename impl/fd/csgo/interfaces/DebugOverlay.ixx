...
export module fd.csgo.interfaces.DebugOverlay;
...
export namespace fd::csgo
{
    ...
    class IVDebugOverlay
    {
      public:
        ...
        virtual void AddBoxOverlay(const math::vector3& origin,
                                   const math::vector3& mins,
                                   const math::vector3& max,
                                   const math::qangle& orientation,
                                   int r,
                                   int g,
                                   int b,
                                   int a,
        ...
        virtual void AddTriangleOverlay(const math::vector3& p1,
        ...
        virtual void AddSweptBoxOverlay(const math::vector3& start,
        ...
        virtual void AddBoxOverlay2(const math::vector3& origin,
                                    const math::vector3& mins,
                                    const math::vector3& max,
                                    const math::qangle& orientation,
                                    const uint8_t* faceColor,
                                    const uint8_t* edgeColor,
                                    float duration)                                                                                                                   = 0;
