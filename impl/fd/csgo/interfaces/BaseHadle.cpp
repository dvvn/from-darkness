...
module fd.csgo.interfaces.BaseHandle;
import fd.csgo.interfaces.ClientEntityList;
import fd.csgo.interfaces.ClientEntity;
...
IHandleEntity* CBaseHandle::Get() const
{
    /*if (!IsValid( ))
        return 0;*/
    return FD_OBJECT_GET(IClientEntityList)->GetClientEntityFromHandle(*this);
}
