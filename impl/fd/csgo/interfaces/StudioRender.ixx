...
export module fd.csgo.interfaces.StudioRender;
export import fd.csgo.interfaces.Studio;
export import fd.csgo.interfaces.AppSystem;
export import fd.csgo.interfaces.ModelRender;
...
export namespace fd::csgo
{
    ...
    class IStudioRender : public IAppSystem
    {
      public:
        ...
        virtual void AddShadow(IMaterial* pMaterial,
                               void* pProxyData,
