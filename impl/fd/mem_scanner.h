...
#define MAKE_FILTER(_T_) find_callback<_T_, Fn>(filter).base()
...
void *find_bytes(void *begin, void *end, void const *bytes, size_t length, find_filter *filter = nullptr);

template <typename Fn>
void *find_bytes(void *begin, void *end, void const *bytes, size_t length, Fn filter)
{
