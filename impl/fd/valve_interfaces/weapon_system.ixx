...
export module fd.valve.weapon_system;
...
enum item_definition_index : uint16_t
{
    WEAPON_NONE                         = 0,
    WEAPON_DEAGLE                       = 1,
    WEAPON_ELITE                        = 2,
...
{
    virtual ~weapon_system() = default;
    virtual void unknown()   = 0;

    virtual weapon_info* GetWpnData(item_definition_index index) = 0;
};
