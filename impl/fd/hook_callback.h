...
#define FD_HOOK_CALLBACK_MEMBER(_CCVS_)                                                                                                             \
    ...
    {                                                                                                                                               \
        friend struct hook_original_proxy<Class, Ret (__##_CCVS_ Class::*)(Args...)>;                                                               \
        ...
        {                                                                                                                                           \
            return invoke(                                                                                                                          \
                self_->callback_, /*---*/                                                                                                           \
                hook_original_proxy(this, _force_cast(self_->get_original_method(), &hook_callback::proxy)),                                        \
                ...
                std::forward<Args>(args)...                                                                                                         \
                                                                                                                                                    ...
                                                                                                                                                    \
      public:                                                                                                                                       \
        hook_callback(Ret (__##_CCVS_ Class::*target)(Args...), Callback callback)                                                                  \
            : callback_(std::move(callback))                                                                                                        \
        {                                                                                                                                           \
            self_ = this;                                                                                                                           \
            hook_impl::init(decay_fn(target), decay_fn(&hook_callback::proxy));                                                                     \
        }                                                                                                                                           \
        hook_callback(Ret (__##_CCVS_ Class::*)(Args...), void* target, Callback callback)                                                          \
            : callback_(std::move(callback))                                                                                                        \
        {                                                                                                                                           \
            self_ = this;                                                                                                                           \
    ...
    template <typename Callback, typename Ret, class Class, typename... Args>                                                                       \
    hook_callback(Ret (__##_CCVS_ Class::*)(Args...), Callback) -> hook_callback<std::decay_t<Callback>, Ret, call_cvs::_CCVS_##_, Class, Args...>; \
    template <typename Callback, typename Ret, class Class, typename... Args>                                                                       \
    hook_callback(Ret (__##_CCVS_ Class::*)(Args...), void*, Callback) -> hook_callback<std::decay_t<Callback>, Ret, call_cvs::_CCVS_##_, Class, Args...>;
...
#define FD_HOOK_CALLBACK(_CCVS_)                                                                                                          \
    ...
    {                                                                                                                                     \
        friend struct hook_original_proxy<void, Ret(__##_CCVS_*)(Args...)>;                                                               \
        inline static hook_callback* self_;                                                                                               \
        Callback                     callback_;                                                                                           \
        ...
        {                                                                                                                                 \
            return invoke(                                                                                                                \
                self_->callback_, /*---*/                                                                                                 \
                hook_original_proxy(_force_cast(self_->get_original_method(), &hook_callback::proxy)),                                    \
                std::forward<Args>(args)...                                                                                               \
            );                                                                                                                            \
        }                                                                                                                                 \
                                                                                                                                          \
      public:                                                                                                                             \
        hook_callback(Ret(__##_CCVS_* target)(Args...), Callback callback)                                                                \
            : callback_(std::move(callback))                                                                                              \
        {                                                                                                                                 \
            self_ = this;                                                                                                                 \
            this->init(decay_fn(target), decay_fn(&hook_callback::proxy));                                                                \
        }                                                                                                                                 \
        hook_callback(Ret(__##_CCVS_*)(Args...), void* target, Callback callback)                                                         \
            : callback_(std::move(callback))                                                                                              \
        {                                                                                                                                 \
            self_ = this;                                                                                                                 \
    ...
    template <typename Callback, typename Ret, typename... Args>                                                                          \
    hook_callback(Ret(__##_CCVS_*)(Args...), Callback) -> hook_callback<std::decay_t<Callback>, Ret, call_cvs::_CCVS_##_, void, Args...>; \
    template <typename Callback, typename Ret, typename... Args>                                                                          \
    hook_callback(Ret(__##_CCVS_*)(Args...), void*, Callback) -> hook_callback<std::decay_t<Callback>, Ret, call_cvs::_CCVS_##_, void, Args...>;
