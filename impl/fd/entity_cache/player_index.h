...
constexpr bool validate_player_index(entity_index<entity_index_source::csgo> index)
{
    return index != 0 && index <= max_player_count;
}

constexpr bool validate_player_index(entity_index<entity_index_source::own> index)
{
...
using game_player_index = player_index<entity_index_source::game>;
