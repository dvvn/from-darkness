...
namespace fd
{
void* resolve_relative_address(void const* address, ptrdiff_t const rva_offset, ptrdiff_t const rip_offset)
{
...
void* get_absolute_address(void const* relative_address, ptrdiff_t const pre_offset, ptrdiff_t const post_offset)
{
