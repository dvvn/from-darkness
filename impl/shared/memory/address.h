...
void* resolve_relative_address(void const* address, ptrdiff_t rva_offset, ptrdiff_t rip_offset);
...
void* get_absolute_address(void const* relative_address, ptrdiff_t pre_offset = 0, ptrdiff_t post_offset = 0);
} // namespace fd
