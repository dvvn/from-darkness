...
void render_if_shown(render_frame_data const &data, render_frame_menu_data<render_frame_menu_mode::single> const &menu_data);
void render_if_shown(render_frame_data const &data, render_frame_menu_data<render_frame_menu_mode::multi> const &menu_data);
} // namespace detail
...
class render_frame final : public basic_render_frame
{
  ...
  public:
    ...
    render_frame(render_frame_data data, auto menu_data)
        : data_(std::move(data))
        , menu_data_(std::move(menu_data))
    {
    }
