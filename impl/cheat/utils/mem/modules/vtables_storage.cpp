...
optional<vtable_info> _Load_vtable_info(const section_info& dot_rdata, const section_info& dot_text, address type_descriptor)
{
...
data_cache_result vtables_storage::Load_from_memory_impl( )
{
#ifdef UTILS_X64
	...
	return load_data_storage.empty( ) ? data_cache_result::error : data_cache_result::success;
}

data_cache_result vtables_storage::Write_to_file_impl(ptree& cache) const
{
...
data_cache_result vtables_storage::Load_from_file_impl(const ptree& cache)
{
