...
export namespace cheat::csgo
{
	...
	_INLINE_VAR constexpr texture_string_t TEXTURE_GROUP_LIGHTMAP = "Lightmaps";
	_INLINE_VAR	constexpr texture_string_t TEXTURE_GROUP_WORLD = "World textures";
	_INLINE_VAR	constexpr texture_string_t TEXTURE_GROUP_MODEL = "Model textures";
	_INLINE_VAR	constexpr texture_string_t TEXTURE_GROUP_VGUI = "VGUI textures";
	_INLINE_VAR	constexpr texture_string_t TEXTURE_GROUP_PARTICLE = "Particle textures";
	_INLINE_VAR	constexpr texture_string_t TEXTURE_GROUP_DECAL = "Decal textures";
	_INLINE_VAR	constexpr texture_string_t TEXTURE_GROUP_SKYBOX = "SkyBox textures";
	_INLINE_VAR	constexpr texture_string_t TEXTURE_GROUP_CLIENT_EFFECTS = "ClientEffect textures";
	_INLINE_VAR	constexpr texture_string_t TEXTURE_GROUP_OTHER = "Other textures";
	_INLINE_VAR	constexpr texture_string_t TEXTURE_GROUP_PRECACHED = "Precached";
	_INLINE_VAR	constexpr texture_string_t TEXTURE_GROUP_CUBE_MAP = "CubeMap textures";
	_INLINE_VAR	constexpr texture_string_t TEXTURE_GROUP_RENDER_TARGET = "RenderTargets";
	_INLINE_VAR	constexpr texture_string_t TEXTURE_GROUP_UNACCOUNTED = "Unaccounted textures";
	// _INLINE_VAR constexpr texture_string_t TEXTURE_GROUP_STATIC_VERTEX_BUFFER	=	  "Static Vertex";
	_INLINE_VAR	constexpr texture_string_t TEXTURE_GROUP_STATIC_INDEX_BUFFER = "Static Indices";
	_INLINE_VAR	constexpr texture_string_t TEXTURE_GROUP_STATIC_VERTEX_BUFFER_DISP = "Displacement Verts";
	_INLINE_VAR	constexpr texture_string_t TEXTURE_GROUP_STATIC_VERTEX_BUFFER_COLOR = "Lighting Verts";
	_INLINE_VAR constexpr texture_string_t TEXTURE_GROUP_STATIC_VERTEX_BUFFER_WORLD = "World Verts";
	_INLINE_VAR constexpr texture_string_t TEXTURE_GROUP_STATIC_VERTEX_BUFFER_MODELS = "Model Verts";
	_INLINE_VAR constexpr texture_string_t TEXTURE_GROUP_STATIC_VERTEX_BUFFER_OTHER = "Other Verts";
	_INLINE_VAR constexpr texture_string_t TEXTURE_GROUP_DYNAMIC_INDEX_BUFFER = "Dynamic Indices";
	_INLINE_VAR constexpr texture_string_t TEXTURE_GROUP_DYNAMIC_VERTEX_BUFFER = "Dynamic Verts";
	_INLINE_VAR constexpr texture_string_t TEXTURE_GROUP_DEPTH_BUFFER = "DepthBuffer";
	_INLINE_VAR constexpr texture_string_t TEXTURE_GROUP_VIEW_MODEL = "ViewModel";
	_INLINE_VAR constexpr texture_string_t TEXTURE_GROUP_PIXEL_SHADERS = "Pixel Shaders";
	_INLINE_VAR constexpr texture_string_t TEXTURE_GROUP_VERTEX_SHADERS = "Vertex Shaders";
	_INLINE_VAR constexpr texture_string_t TEXTURE_GROUP_RENDER_TARGET_SURFACE = "RenderTarget Surfaces";
	_INLINE_VAR constexpr texture_string_t TEXTURE_GROUP_MORPH_TARGETS = "Morph Targets";
