...
export namespace cheat::csgo
{
	...
	constexpr std::string_view TEXTURE_GROUP_LIGHTMAP = "Lightmaps";
	constexpr std::string_view TEXTURE_GROUP_WORLD = "World textures";
	constexpr std::string_view TEXTURE_GROUP_MODEL = "Model textures";
	constexpr std::string_view TEXTURE_GROUP_VGUI = "VGUI textures";
	constexpr std::string_view TEXTURE_GROUP_PARTICLE = "Particle textures";
	constexpr std::string_view TEXTURE_GROUP_DECAL = "Decal textures";
	constexpr std::string_view TEXTURE_GROUP_SKYBOX = "SkyBox textures";
	constexpr std::string_view TEXTURE_GROUP_CLIENT_EFFECTS = "ClientEffect textures";
	constexpr std::string_view TEXTURE_GROUP_OTHER = "Other textures";
	constexpr std::string_view TEXTURE_GROUP_PRECACHED = "Precached";
	constexpr std::string_view TEXTURE_GROUP_CUBE_MAP = "CubeMap textures";
	constexpr std::string_view TEXTURE_GROUP_RENDER_TARGET = "RenderTargets";
	constexpr std::string_view TEXTURE_GROUP_UNACCOUNTED = "Unaccounted textures";
	//constexpr std::string_view TEXTURE_GROUP_STATIC_VERTEX_BUFFER	=	  "Static Vertex";
	constexpr std::string_view TEXTURE_GROUP_STATIC_INDEX_BUFFER = "Static Indices";
	constexpr std::string_view TEXTURE_GROUP_STATIC_VERTEX_BUFFER_DISP = "Displacement Verts";
	constexpr std::string_view TEXTURE_GROUP_STATIC_VERTEX_BUFFER_COLOR = "Lighting Verts";
	constexpr std::string_view TEXTURE_GROUP_STATIC_VERTEX_BUFFER_WORLD = "World Verts";
	constexpr std::string_view TEXTURE_GROUP_STATIC_VERTEX_BUFFER_MODELS = "Model Verts";
	constexpr std::string_view TEXTURE_GROUP_STATIC_VERTEX_BUFFER_OTHER = "Other Verts";
	constexpr std::string_view TEXTURE_GROUP_DYNAMIC_INDEX_BUFFER = "Dynamic Indices";
	constexpr std::string_view TEXTURE_GROUP_DYNAMIC_VERTEX_BUFFER = "Dynamic Verts";
	constexpr std::string_view TEXTURE_GROUP_DEPTH_BUFFER = "DepthBuffer";
	constexpr std::string_view TEXTURE_GROUP_VIEW_MODEL = "ViewModel";
	constexpr std::string_view TEXTURE_GROUP_PIXEL_SHADERS = "Pixel Shaders";
	constexpr std::string_view TEXTURE_GROUP_VERTEX_SHADERS = "Vertex Shaders";
	constexpr std::string_view TEXTURE_GROUP_RENDER_TARGET_SURFACE = "RenderTarget Surfaces";
	constexpr std::string_view TEXTURE_GROUP_MORPH_TARGETS = "Morph Targets";
