...
namespace cheat::csgo
{
	...
	constexpr auto& TEXTURE_GROUP_LIGHTMAP = "Lightmaps";
	constexpr auto& TEXTURE_GROUP_WORLD = "World textures";
	constexpr auto& TEXTURE_GROUP_MODEL = "Model textures";
	constexpr auto& TEXTURE_GROUP_VGUI = "VGUI textures";
	constexpr auto& TEXTURE_GROUP_PARTICLE = "Particle textures";
	constexpr auto& TEXTURE_GROUP_DECAL = "Decal textures";
	constexpr auto& TEXTURE_GROUP_SKYBOX = "SkyBox textures";
	constexpr auto& TEXTURE_GROUP_CLIENT_EFFECTS = "ClientEffect textures";
	constexpr auto& TEXTURE_GROUP_OTHER = "Other textures";
	constexpr auto& TEXTURE_GROUP_PRECACHED = "Precached";
	constexpr auto& TEXTURE_GROUP_CUBE_MAP = "CubeMap textures";
	constexpr auto& TEXTURE_GROUP_RENDER_TARGET = "RenderTargets";
	constexpr auto& TEXTURE_GROUP_UNACCOUNTED = "Unaccounted textures";
	//constexpr auto& TEXTURE_GROUP_STATIC_VERTEX_BUFFER	=	  "Static Vertex";
	constexpr auto& TEXTURE_GROUP_STATIC_INDEX_BUFFER = "Static Indices";
	constexpr auto& TEXTURE_GROUP_STATIC_VERTEX_BUFFER_DISP = "Displacement Verts";
	constexpr auto& TEXTURE_GROUP_STATIC_VERTEX_BUFFER_COLOR = "Lighting Verts";
	constexpr auto& TEXTURE_GROUP_STATIC_VERTEX_BUFFER_WORLD = "World Verts";
	constexpr auto& TEXTURE_GROUP_STATIC_VERTEX_BUFFER_MODELS = "Model Verts";
	constexpr auto& TEXTURE_GROUP_STATIC_VERTEX_BUFFER_OTHER = "Other Verts";
	constexpr auto& TEXTURE_GROUP_DYNAMIC_INDEX_BUFFER = "Dynamic Indices";
	constexpr auto& TEXTURE_GROUP_DYNAMIC_VERTEX_BUFFER = "Dynamic Verts";
	constexpr auto& TEXTURE_GROUP_DEPTH_BUFFER = "DepthBuffer";
	constexpr auto& TEXTURE_GROUP_VIEW_MODEL = "ViewModel";
	constexpr auto& TEXTURE_GROUP_PIXEL_SHADERS = "Pixel Shaders";
	constexpr auto& TEXTURE_GROUP_VERTEX_SHADERS = "Vertex Shaders";
	constexpr auto& TEXTURE_GROUP_RENDER_TARGET_SURFACE = "RenderTarget Surfaces";
	constexpr auto& TEXTURE_GROUP_MORPH_TARGETS = "Morph Targets";
