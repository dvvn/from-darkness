...
export module cheat.csgo.structs:ConVar;
...
export namespace cheat::csgo
{
	...
	public:
		...
		template < >
		const char* get() const { return _Get_helper<const char*>(this, 11); }

		template < >
		float get() const { return _Get_helper<float>(this, 12); }

		template < >
		int get() const { return _Get_helper<int>(this, 13); }

		template < >
		bool get() const { return !!this->get<int>(); }

		template <typename T>
		void set(T value);

		template < >
		void set(const char* value) { _Set_helper(this, 14, value); }

		template < >
		void set(float value) { _Set_helper(this, 15, value); }

		template < >
		void set(int value) { _Set_helper(this, 16, value); }
