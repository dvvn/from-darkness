...
export namespace cheat::csgo
{
	...
	{
	public:
		virtual int DrawModel(int flags, IClientRenderable* pRenderable, ModelInstanceHandle_t instance, int entity_index, const model_t* model, const math::vector3& origin,
							  const math::qangle& angles,
							  int skin, int body, int hitboxset, const math::matrix3x4* modelToWorld = 0, const math::matrix3x4* pLightingOffset = 0) = 0;
