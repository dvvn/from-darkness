...
export module fds.netvars.core:basic_storage;
...
using netvar_info_source = std::variant<fds::csgo::RecvProp*, fds::csgo::typedescription_t*>;
...
class netvar_table : public std::vector<std::unique_ptr<basic_netvar_info>>
{
  ...
  public:
    ...
    {
        return add(std::forward<From>(from), name, std::invoke(proj, fds::tools::csgo_object_name<Type>));
    }
};
