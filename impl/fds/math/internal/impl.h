...
#define FDS_MATH_ARRAY_INIT(_CLASS_NAME_, _ARG_TYPE_, _ARGS_COUNT_)                                                 \
...
#define FDS_MATH_OP_EQ(_CLASS_NAME_)             \
    FDS_MATH_OP_EQ_IMPL(_CLASS_NAME_, bool, ==); \
    FDS_MATH_OP_EQ_IMPL(_CLASS_NAME_, bool, !=); \
    FDS_MATH_OP_EQ_IMPL(_CLASS_NAME_, bool, <);  \
    FDS_MATH_OP_EQ_IMPL(_CLASS_NAME_, bool, <=); \
    FDS_MATH_OP_EQ_IMPL(_CLASS_NAME_, bool, >);  \
...
#define FDS_MATH_OP(_CLASS_NAME_)     \
    FDS_MATH_OP_IMPL(_CLASS_NAME_, +) \
    FDS_MATH_OP_IMPL(_CLASS_NAME_, -) \
    FDS_MATH_OP_IMPL(_CLASS_NAME_, *) \
    FDS_MATH_OP_IMPL(_CLASS_NAME_, /) \
    FDS_MATH_OP_EQ(_CLASS_NAME_)
