...
module fds.gui.render_interface;
...
FDS_OBJECT_BIND(custom_render_interface, render_interface, RenderInterfaceD3d9);
FDS_OBJECT_BIND(Rml::RenderInterface, render_interface_raw, RenderInterfaceD3d9);
...
RenderInterfaceD3d9::RenderInterfaceD3d9()
{
    const auto d3d = &FDS_OBJECT_GET(IDirect3DDevice9);
