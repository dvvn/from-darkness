...
export module fds.tools.object_name;
...
{
    template <typename T>
    constexpr std::string_view object_name = drop_type_namespace<T>("fds");

    /* template <typename T>
    constexpr std::string_view csgo_object_name = drop_type_namespace<T>("fds::csgo"); */
} // namespace fds
