...
#define FDS_AUTO_OBJECT_ID       _Object_id(__FILE__)
// take file name without object id
#define FDS_AUTO_OBJECT_NAME     _Pretty_file_name(__FILE__, false)
// take folder name where the current file is located
#define FDS_AUTO_OBJECT_LOCATION _Folder_name(__FILE__)
