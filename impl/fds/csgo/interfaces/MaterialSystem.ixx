...
export module fds.csgo.interfaces.MaterialSystem;
...
export namespace fds::csgo
{
    ...
    {
      public:
        virtual CreateInterfaceFn Init(const char* pShaderAPIDLL, IMaterialProxyFactory* pMaterialProxyFactory, CreateInterfaceFn fileSystemFactory, CreateInterfaceFn cvarFactory = 0)                                                                                                                                      = 0;
