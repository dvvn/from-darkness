export module fds.csgo.interfaces.InputSystem;
...
{
    constexpr auto MAX_SPLITSCREEN_CLIENT_BITS = 2;
    // this should == MAX_JOYSTICKS in InputEnums.h
    constexpr auto MAX_SPLITSCREEN_CLIENTS = (1 << MAX_SPLITSCREEN_CLIENT_BITS); // 4
