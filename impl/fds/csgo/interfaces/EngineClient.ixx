...
export module fds.csgo.interfaces.EngineClient;
export import fds.csgo.interfaces.MaterialSystem;
...
export namespace fds::csgo
{
    ...
    class IVEngineClient
    {
      public:
        ...
        virtual void SphereTracePaintSurface(const model_t* model, const math::vector3& position, const math::vector3& vec2, float radius, /*CUtlVector<unsigned char, CUtlMemory<unsigned char, int>>*/ int& utilVecShit) = 0;
