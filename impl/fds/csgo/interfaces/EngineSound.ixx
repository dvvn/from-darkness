export module fds.csgo.interfaces.EngineSound;
...
export namespace fds::csgo
{
    ...
    class IEngineSound
    {
      public:
        ...
        virtual int EmitSound(IRecipientFilter& filter, int iEntIndex, int iChannel, const char* pSoundEntry, unsigned int nSoundEntryHash, const char* pSample, float flVolume, float flAttenuation, int nSeed, int iFlags = 0, int iPitch = PITCH_NORM, const math::vector3* pOrigin = 0, const math::vector3* pDirection = 0, CUtlVector<math::vector3>* pUtlVecOrigins = 0, bool bUpdatePositions = true, float soundtime = 0.0f, int speakerentity = -1) = 0;

        virtual int EmitSound(IRecipientFilter& filter, int iEntIndex, int iChannel, const char* pSoundEntry, unsigned int nSoundEntryHash, const char* pSample, float flVolume, soundlevel_t iSoundlevel, int nSeed, int iFlags = 0, int iPitch = PITCH_NORM, const math::vector3* pOrigin = 0, const math::vector3* pDirection = 0, CUtlVector<math::vector3>* pUtlVecOrigins = 0, bool bUpdatePositions = true, float soundtime = 0.0f, int speakerentity = -1) = 0;

        virtual void EmitSentenceByIndex(IRecipientFilter& filter, int iEntIndex, int iChannel, int iSentenceIndex, float flVolume, soundlevel_t iSoundlevel, int nSeed, int iFlags = 0, int iPitch = PITCH_NORM, const math::vector3* pOrigin = 0, const math::vector3* pDirection = 0, CUtlVector<math::vector3>* pUtlVecOrigins = 0, bool bUpdatePositions = true, float soundtime = 0.0f, int speakerentity = -1) = 0;
