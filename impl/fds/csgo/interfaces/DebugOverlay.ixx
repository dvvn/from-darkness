...
export module fds.csgo.interfaces.DebugOverlay;
...
export namespace fds::csgo
{
    ...
    class IVDebugOverlay
    {
      public:
        ...
        virtual void AddBoxOverlay2(const math::vector3& origin, const math::vector3& mins, const math::vector3& max, const math::qangle& orientation, const uint8_t* faceColor, const uint8_t* edgeColor, float duration)   = 0;
